...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/statistics.css" />
    ...
    <script type="text/javascript" src="/assets/userscripts/require.min.js"></script>
